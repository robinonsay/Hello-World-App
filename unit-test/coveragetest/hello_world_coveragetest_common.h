 ...
 * @file
 *
 * Common definitions for all hello_world coverage tests
 */

#ifndef HELLO_WORLD_COVERAGETEST_COMMON_H
#define HELLO_WORLD_COVERAGETEST_COMMON_H
...
#endif /* HELLO_WORLD_COVERAGETEST_COMMON_H */
